...
for (const { name, data } of FIXTURES) {
  ...
  test(`lzma cross-compat, ours -> native: ${name}`, async (t) => {
  ...
  test(`lzma cross-compat, native -> ours: ${name}`, async (t) => {
