...
//
// HAND-AUTHORED to mirror the Uint8Array browser runtime in `lzma.browser.js`
...
// `lzma.d.ts` (which the Node/default condition keeps, together with the
...
/** Options for the `.lzma` (LZMA1) streaming compressor. */
...
/**
 * Compress a `ReadableStream<Uint8Array>` into a `.lzma` byte stream (Web Streams
...
/** Incremental `.lzma` compressor (Web/browser surface: Uint8Array in / out). */
...
/** Incremental `.lzma` decompressor (Web/browser surface: Uint8Array in / out). */
