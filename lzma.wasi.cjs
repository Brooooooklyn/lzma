// napi-rs-artifact-metadata:{"version":2,"rootEntry":"index.js","exports":["Lzma2Compressor","Lzma2Decompressor","LzmaCompressor","LzmaDecompressor","XzCompressor","XzDecompressor","lzma","lzma2","xz"],"managedRootEntries":["browser.js","index.js","lzma.wasm","lzma.debug.wasm"]}
/* eslint-disable */
/* prettier-ignore */
...
let __wasmFilePath = __nodePath.join(__dirname, 'lzma.wasm32-wasi.wasm')
const __wasmDebugFilePath = __nodePath.join(__dirname, 'lzma.wasm32-wasi.debug.wasm')

if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  __wasmFilePath = __wasmDebugFilePath
} else if (!__nodeFs.existsSync(__wasmFilePath)) {
  const __wasiPackageEntry = require.resolve('@napi-rs/lzma-wasm32-wasi')
  const __packagedWasmFilePath = __nodePath.join(
    __nodePath.dirname(__wasiPackageEntry),
    'lzma.wasm32-wasi.wasm',
  )
  if (!__nodeFs.existsSync(__packagedWasmFilePath)) {
    throw new Error(
      '@napi-rs/lzma-wasm32-wasi is installed but is missing lzma.wasm32-wasi.wasm.',
    )
  }
...
module.exports.Lzma2Compressor = __napiModule.exports.Lzma2Compressor
module.exports.Lzma2Decompressor = __napiModule.exports.Lzma2Decompressor
module.exports.LzmaCompressor = __napiModule.exports.LzmaCompressor
module.exports.LzmaDecompressor = __napiModule.exports.LzmaDecompressor
module.exports.XzCompressor = __napiModule.exports.XzCompressor
module.exports.XzDecompressor = __napiModule.exports.XzDecompressor
